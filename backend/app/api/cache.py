...
async def cache_health_check() -> Dict[str, Any]:
    ...
    try:
        ...
        print(f"Error in cache health check: {e}")
...
async def clear_cache(pattern: str = "*") -> Dict[str, str]:
    ...
    try:
        ...
        print(f"Cache cleared: {deleted_count} keys deleted")
...
async def clear_embedding_cache() -> Dict[str, str]:
    ...
    try:
        ...
        print(f"Embedding cache cleared: {deleted_count} keys deleted")
...
async def clear_llm_cache() -> Dict[str, str]:
    ...
    try:
        ...
        print(f"LLM cache cleared: {deleted_count} keys deleted")
...
async def clear_rag_cache() -> Dict[str, str]:
    ...
    try:
        ...
        print(f"RAG cache cleared: {deleted_count} keys deleted")
